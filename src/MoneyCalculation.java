...
private BigDecimal getMultip(){
    return fAmountTwo.multiply(fAmountOne);
  }
  ...
  private BigDecimal rounded(BigDecimal aNumber){
    ...
    BigDecimal amountOne = new BigDecimal("1000");
    BigDecimal amountTwo = new BigDecimal("567.1");
